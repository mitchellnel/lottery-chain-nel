...
const txClient = async (
    ...
    return {
        ...
        msgChangeEntranceFee: (data: MsgChangeEntranceFee): EncodeObject => ({
            typeUrl: "/lotterychainnel.lottery.MsgChangeEntranceFee",
            value: MsgChangeEntranceFee.fromPartial(data),
        }),
        msgSetupLottery: (data: MsgSetupLottery): EncodeObject => ({
            typeUrl: "/lotterychainnel.lottery.MsgSetupLottery",
            value: MsgSetupLottery.fromPartial(data),
        }),
        msgClaimOwner: (data: MsgClaimOwner): EncodeObject => ({
            typeUrl: "/lotterychainnel.lottery.MsgClaimOwner",
            value: MsgClaimOwner.fromPartial(data),
        }),
        msgChangeOwner: (data: MsgChangeOwner): EncodeObject => ({
            typeUrl: "/lotterychainnel.lottery.MsgChangeOwner",
            value: MsgChangeOwner.fromPartial(data),
        }),
        msgEnterLottery: (data: MsgEnterLottery): EncodeObject => ({
            typeUrl: "/lotterychainnel.lottery.MsgEnterLottery",
            value: MsgEnterLottery.fromPartial(data),
        }),
    };
};
