...
import LotteryChainNelLotterychainnelLottery from "./github.com/mitchellnel/lottery-chain-nel/lotterychainnel.lottery";
...
export default {
    ...
    CosmosIbcGoIbcCorePortV1: load(
        CosmosIbcGoIbcCorePortV1,
        "ibc.core.port.v1"
    ),
    LotteryChainNelLotterychainnelLottery: load(
        LotteryChainNelLotterychainnelLottery,
        "lotterychainnel.lottery"
    ),
};
