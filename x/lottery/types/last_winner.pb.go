...
func (m *LastWinner) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
var fileDescriptor_8a9f3bac52f8b7e2 = []byte{
	...
	0xa0, 0x7c, 0x25, 0x35, 0x2e, 0x2e, 0x9f, 0xc4, 0xe2, 0x92, 0x70, 0xb0, 0x62, 0x21, 0x09, 0x2e,
	0xf6, 0xc4, 0x94, 0x94, 0xa2, 0xd4, 0xe2, 0x62, 0x09, 0x46, 0x05, 0x46, 0x0d, 0xce, 0x20, 0x18,
	0xd7, 0x29, 0xe8, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c,
	0xf0, 0x58, 0x8e, 0xe1, 0xc2, 0x63, 0x39, 0x86, 0x1b, 0x8f, 0xe5, 0x18, 0xa2, 0x2c, 0xd2, 0x33,
	0x4b, 0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x73, 0x33, 0x4b, 0x92, 0x33, 0x52, 0x73,
	0x72, 0xf2, 0x52, 0x73, 0xf4, 0xa1, 0x36, 0xe8, 0x82, 0xad, 0xd4, 0x05, 0x89, 0x54, 0xc0, 0xc4,
	0xf4, 0x4b, 0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0x6e, 0x33, 0x06, 0x04, 0x00, 0x00, 0xff,
	0xff, 0x7e, 0xaf, 0x8a, 0x9a, 0xb8, 0x00, 0x00, 0x00,
}
...
func (m *LastWinner) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Address) > 0 {
		...
		i = encodeVarintLastWinner(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0xa
	}
