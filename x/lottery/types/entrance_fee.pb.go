...
type EntranceFee struct {
	EntranceFee uint64 `protobuf:"varint,1,opt,name=entrance_fee,json=entranceFee,proto3" json:"entrance_fee,omitempty"`
}
...
func (m *EntranceFee) GetEntranceFee() uint64 {
	if m != nil {
...
var fileDescriptor_db5c062f03d5f14d = []byte{
	...
	0xa5, 0xe6, 0xe8, 0x41, 0xf9, 0x4a, 0x06, 0x5c, 0xdc, 0xae, 0x50, 0xe5, 0x6e, 0xa9, 0xa9, 0x42,
	0x8a, 0x5c, 0x3c, 0xc8, 0xba, 0x25, 0x18, 0x15, 0x18, 0x35, 0x58, 0x82, 0xb8, 0x53, 0x11, 0x4a,
	0x9c, 0xac, 0x4f, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39, 0xc6, 0x09,
	0x8f, 0xe5, 0x18, 0x2e, 0x3c, 0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x21, 0x4a, 0x11, 0x6a, 0xa8,
	0x2e, 0xd8, 0x16, 0xdd, 0xbc, 0xd4, 0x1c, 0xfd, 0x0a, 0x7d, 0x98, 0xa3, 0x4a, 0x2a, 0x0b, 0x52,
	0x8b, 0x93, 0xd8, 0xc0, 0xce, 0x31, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x1c, 0x4e, 0x0f, 0x02,
	0xac, 0x00, 0x00, 0x00,
}
...
func (m *EntranceFee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.EntranceFee != 0 {
		i = encodeVarintEntranceFee(dAtA, i, uint64(m.EntranceFee))
		i--
		dAtA[i] = 0x8
	}
...
func (m *EntranceFee) Size() (n int) {
	...
	_ = l
	if m.EntranceFee != 0 {
		n += 1 + sovEntranceFee(uint64(m.EntranceFee))
	}
	return n
}
